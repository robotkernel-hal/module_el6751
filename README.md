The **module\_el6751** is a robotkernel-5 handler module for the
...
CAN messages can be sent or received – without having to bother with CAN
frames in the applications program.
...
each time new process data is written to *pd\_inputs\_device*. After
that, the trigger of *pd\_outputs\_device* will be called.
